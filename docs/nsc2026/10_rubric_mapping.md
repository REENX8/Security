...
|------|-----------|----------|
| Feature Engineering | 33 features หลายกลุ่ม + ออกแบบใหม่ schema v1.3.0 | `phish_features/schema.py`, `extractor.py` |
...
* CI gate Thai recall ≥ 0.85 → ปัจจุบัน 100% (PASS)
...
✅ 33-feature schema + IDN defense + Rules Engine + Campaign clustering
