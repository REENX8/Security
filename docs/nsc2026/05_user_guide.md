...
### 1.4 ตรวจ URL ผ่าน LINE Bot (ง่ายที่สุดสำหรับผู้ที่ใช้ LINE)

1. เพิ่มบัญชี LINE Bot ของระบบเป็นเพื่อน
2. พิมพ์ URL ที่สงสัยส่งเข้าแชท
3. ระบบตอบกลับทันทีพร้อม verdict และเหตุผลเป็นภาษาไทย:
   - `✅ ลิงก์นี้ดูปลอดภัย` — score < 0.4
   - `🟡 โปรดระวัง — ลิงก์นี้น่าสงสัย...` — score 0.4–0.7
   - `⚠️ ระบบตรวจพบว่าลิงก์นี้อาจเป็นฟิชชิง ❌ ไม่ควรคลิก...` — score > 0.7

### 1.5 อ่านเนื้อหาให้ความรู้
...
4. **วิธีง่ายที่สุด:** เพิ่ม LINE Bot แล้วพิมพ์ลิงก์ที่สงสัยส่งเข้าแชท — ระบบตอบกลับภาษาไทยทันที
